...
function Projects() {
    const githubchart='https://ghchart.rshah.org/009900/Luis06000';
    ...
    return (
        <div className='projects'>
              ...
              <div className="card">
                  <div className="card2">
                    ...
                    <div className="card-info">
                      <p className="text-title">Front-end pioneers' challenge</p>
                      <p className="text-body">This project is a React web application that serves as a dashboard to visualize and configure a mobile simulation. It allows users to monitor and control various simulation-related parameters, view mobile details, view mobile movement on a map, and analyze density plots. Additionally, it provides a video player to view a video stream.</p>
                    </div>
                    <div className="card-footer">
                      <button className="btn-github" onClick={() => window.open('https://github.com/gabrielgonta/navalgroup_coding_ghost', '_blank')}>
                        <svg
                          width="16"
                          height="16"
                          viewBox="0 0 16 16"
          ...
          <div style={{ textAlign: "center", marginTop: '12em', position:'relative', zIndex:10}}>
            ...
            />
            <figcaption style={{ marginTop: "1em", fontStyle: "italic", textAlign:'right', marginRight:'10em', fontSize:'1.2em' }}>
              Less → 
              <span style={{ display: 'inline-block', width: '12px', height: '12px', backgroundColor: '#ebedf0', border: '1px solid #ccc', marginRight: '5px' }}></span> 
              <span style={{ display: 'inline-block', width: '12px', height: '12px', backgroundColor: '#9be9a8', border: '1px solid #ccc', marginRight: '5px' }}></span> 
              <span style={{ display: 'inline-block', width: '12px', height: '12px', backgroundColor: '#40c463', border: '1px solid #ccc', marginRight: '5px' }}></span> 
              <span style={{ display: 'inline-block', width: '12px', height: '12px', backgroundColor: '#30a14e', border: '1px solid #ccc', marginRight: '5px' }}></span> 
              <span style={{ display: 'inline-block', width: '12px', height: '12px', backgroundColor: '#216e39', border: '1px solid #ccc' }}></span>
              → More
            </figcaption>
          </div>
          <h1 className='coming-soon'>More projects are coming soon...</h1>
        </div>
