        ...
        <div className='projects'>
                    ...
                    <div className='password-manager'>
                        <div className="card">
                            <div className="card2">
                                <div className="card-img"></div>
                                <div className="card-info">
                                    <p className="text-title">Password Manager</p>
                                ...
                                <div className="card-footer">
                                    <button className="btn-test" onClick={() => window.open('https://password.luisfds.com', '_blank')}>
                                        Test it
                                    </button>
                    ...
                    <div className='guess-number'>
                        <div className="card">
                            <div className="card2">
                                <div className="card-img"></div>
                                <div className="card-info">
                                    <p className="text-title">Guess The Number</p>
                                    <p className="text-body">This project is an interactive guessing game developed in C++, with several difficulty levels and success systems. It offers a challenging gaming experience with score tracking and progression mechanics, as well as unlockable achievements, creating an engaging environment for players of all levels.</p>
                                </div>
                                <div className="card-footer">
                                    <button className="btn-github" onClick={() => window.open('https://github.com/Luis06000/guess-number', '_blank')}>
                                        <svg
                                            width="16"
                                            height="16"
                                            viewBox="0 0 16 16"
                    ...
                    <div className='CESIFT'>
                        <div className="card">
                            <div className="card2">
                                ...
                                <div className="card-footer">
                                    <button className="btn-test" onClick={() => window.open('https://cesift.luisfds.com', '_blank')}>
                                        Test it
                                    </button>
            ...
            <div className="contributions-section">
                <div className="contributions-container">
                    ...
                    <figcaption className="contributions-legend">
                        Less → 
                        <span className="legend-cube"></span>
                        <span className="legend-cube"></span>
                        <span className="legend-cube"></span>
                        <span className="legend-cube"></span>
                        <span className="legend-cube"></span>
            ...
            <div className='title-container'>
                <div className='title coming-soon-title'>
                    <h1>More projects are coming soon...</h1>
                </div>
            </div>
        </div>
    );
