    ...
    return (
        <footer>
          ...
          <div className="footer">
            ...
            <a href='https://github.com/Luis06000' target='_blank' rel="noopener noreferrer" className="github">
            ...
            <a href='https://discordapp.com/users/510464629919711243' target='_blank' rel="noopener noreferrer" className="discord">
            ...
            <a href='https://www.linkedin.com/in/luis-fernandes-b2a6022b6' target='_blank' rel="noopener noreferrer" className="linkedin">
